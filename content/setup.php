<?php
/**
 * Demo site setup for Spishuset I Härnösand.
 *
 ...
 * Site settings
 * ----------------------------------------------------------------------- */
update_option( 'blogname', 'Spishuset I Härnösand' );
...
$home = nps_page(
	...
	nps_pattern( 'spishusetiharnosand/page-home' ),
...
nps_page(
	'takomlaggning',
	'Takomläggning',
	nps_pattern( 'spishusetiharnosand/page-replacement' ),
...
nps_page(
	...
	nps_pattern( 'spishusetiharnosand/page-storm' ),
...
$quote = nps_page(
	'offert',
	'Boka besiktning',
	nps_pattern( 'spishusetiharnosand/quote-funnel' ),
...
$thanks = nps_page(
	'tack',
	'Tack',
	nps_pattern( 'spishusetiharnosand/thank-you' ),
...
<p class="has-large-font-size">Spishuset I Härnösand är ett familjeföretag från Sollentuna. Vi startade 1996 med en bil och en regel vi fortfarande håller oss till: priset vi skriver ner är priset du betalar.</p>
<!-- /wp:paragraph -->
...
<!-- /wp:list -->
HTML;
nps_page( 'om-oss', 'Om Spishuset I Härnösand', $about_content . "\n\n" . nps_pattern( 'spishusetiharnosand/cta-inline' ), 'Familjeägt takföretag i norra Stockholm sedan 1996. Egna montörer, fasta priser skriftligt och 10 års garanti.' );
...
nps_page( 'vanliga-fragor', 'Vanliga frågor', $faq_content . "\n\n" . nps_pattern( 'spishusetiharnosand/cta-inline' ), 'Svar om offert, pris, ROT-avdrag, hur lång tid en takomläggning tar och vad garantin täcker.' );
...
<!-- /wp:paragraph -->
HTML;
$privacy = nps_page( 'integritetspolicy', 'Integritetspolicy', $privacy_content, 'Så använder Spishuset I Härnösand uppgifterna du skickar med offertformuläret.' );
...
nps_log( 'Spishuset I Härnösand demo ready.' );
