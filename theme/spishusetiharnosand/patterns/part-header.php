...
/**
 * Title: Part: header
 * Slug: spishusetiharnosand/part-header
 * Inserter: no
 *
...
$sp_menu = get_posts( array( 'post_type' => 'wp_navigation', 'title' => 'Main menu', 'numberposts' => 1, 'fields' => 'ids', 'post_status' => 'publish' ) );
$sp_ref  = $sp_menu ? '"ref":' . (int) $sp_menu[0] . ',' : '';
?>
...
<div class="wp-block-group"><!-- wp:navigation {<?php echo $sp_ref; // phpcs:ignore ?>"overlayMenu":"mobile","layout":{"type":"flex","justifyContent":"right"},"style":{"spacing":{"blockGap":"var:preset|spacing|40"}}} /-->

<!-- wp:paragraph {"className":"sp-phone","style":{"typography":{"lineHeight":"1.2"}}} -->
<p class="sp-phone" style="line-height:1.2"><a href="tel:<?php echo esc_attr( sp_lead( 'telefon_tel' ) ); ?>"><?php echo esc_html( sp_lead( 'telefon' ) ); ?></a><small>Vi svarar vard. 07–18</small></p>
<!-- /wp:paragraph -->

<!-- wp:buttons {"className":"sp-header-btn"} -->
<div class="wp-block-buttons sp-header-btn"><!-- wp:button {"className":"sp-track-cta"} -->
<div class="wp-block-button sp-track-cta"><a class="wp-block-button__link wp-element-button" href="<?php echo esc_url( home_url( '/offert' ) ); ?>">Boka besiktning</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
