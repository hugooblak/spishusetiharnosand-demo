<?php
/**
 * Spishuset I Härnösand theme functions.
 *
 * Kept short on purpose. Design lives in theme.json, markup in templates and patterns.
 * Lead capture lives in the "Spishuset I Härnösand Leads" plugin, so leads survive a theme change.
 *
 ...
 * Patterns read these through sp_lead() so one demo can be rebuilt for any firm.
 */
...
add_action(
	'wp_enqueue_scripts',
	function () {
		wp_enqueue_style( 'spishusetiharnosand', get_stylesheet_uri(), array(), wp_get_theme()->get( 'Version' ) );
	}
);
add_action(
	'after_setup_theme',
...
add_action(
	'init',
	function () {
		register_block_style( 'core/paragraph', array( 'name' => 'eyebrow', 'label' => __( 'Eyebrow label', 'spishusetiharnosand' ) ) );
		register_block_style( 'core/list', array( 'name' => 'checklist', 'label' => __( 'Tick list', 'spishusetiharnosand' ) ) );

		register_block_pattern_category( 'spishusetiharnosand-sections', array( 'label' => __( 'Spishuset I Härnösand sections', 'spishusetiharnosand' ) ) );
		register_block_pattern_category( 'spishusetiharnosand-pages', array( 'label' => __( 'Spishuset I Härnösand page layouts', 'spishusetiharnosand' ) ) );
	}
);
